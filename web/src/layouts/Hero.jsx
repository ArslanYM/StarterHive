            ...
            <section className="text-gray-400 bg-gray-900 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-20 lg:pl-12 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p className="sm:inline-block  sm:ml-2 md:ml-0 text-yellow-500 hover:scale-90 transition-transform">
                              Open Source
                        </p>
                        </h1>

                        <p className="mb-8 leading-relaxed">Starter Hive is a platform that helps beginners to contribute to open source projects of<p> remotely hiring organizations.</p></p>
