    ...
    <header className="text-gray-400 bg-gradient-to-r from-gray-700 via-gray-900 to-black  body-font flex-nowrap">
      <div className="container mx-auto flex flex-wrap p-5  flex-col md:flex-row items-center justify-between">
        <nav className="flex  flex-wrap items-center text-base ">
          <Link to="/" className={`px-3 py-1 rounded hover:text-white cursor-pointer font-bold ${path == "/" && "bg-gray-800  "}`}>
            Home
          </Link>
          <Link to="/contributors" className={` px-3 py-1 rounded hover:text-white font-bold cursor-pointer ${path == "/contributors" && "bg-gray-800  "}`}>
            Contributors
          </Link>
          <Link to="/docs" className={` px-3 py-1 rounded hover:text-white font-bold cursor-pointer ${path == "/docs" && "bg-gray-800  "}`}>
            Docs
          </Link>
          <Link to="/issues" className={`hover:text-white cursor-pointer font-bold px-3 py-1 rounded ${path == "/issues" && "bg-gray-800  "}`}>
            Find Issues
          </Link>
        </nav>
