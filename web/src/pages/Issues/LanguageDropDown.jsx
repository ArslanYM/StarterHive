...
const LanguageDropDown = ({
  ...
  return (
    <div className={!theme ? "max-w-full w-max border-2 border-yellow-400 relative text-white py-1 px-2 rounded-lg" :"max-w-full w-max border-2 border-yellow-400 relative text-gray-600 py-1 px-2 rounded-lg" }>
      <div
      ...
      >
        ...
        <span className="dropdown-container flex">
          <span
            className="max-w-xs truncate dropdown-container"
            title={
      ...
      {isDropDownVisible && (
        <div
          className={!theme ? ` absolute top-10 flex w-64 flex-col ju bg-gray-800 border border-gray-700 shadow-xl rounded-md z-10`: ` absolute top-10 flex w-64 flex-col ju bg-gray-300 border border-gray-400 shadow-xl rounded-md z-10`}
        >
          <div className="max-h-96 overflow-x-auto">
            ...
            {dropdownValues.map((language, key) => {
              return (
                <div
                  key={key}
                  className={!theme ?"flex justify-between items-center border-b border-gray-700 px-4 py-2 cursor-pointer hover:bg-gray-600 duration-500 gap-x-1" : "flex justify-between items-center border-b border-gray-700 px-4 py-2 cursor-pointer hover:bg-gray-400 duration-500 gap-x-1"}
          ...
          {selectedLanguages.length > 0 && (
            <div className="flex justify-center">
              <button
                ...
                className="dropdown-container text-xs p-2 hover:cursor-pointer text-yellow-600 underline"
              >
                Clear all filters
              </button>
            </div>
